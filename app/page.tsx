  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-rose-50 via-pink-50 to-white relative overflow-x-hidden">
      ...
      <section className="grid md:grid-cols-3 gap-8 px-6 md:px-20 py-20 text-center">
        {[
          { icon: <MapPin className="w-10 h-10 mx-auto text-rose-500" />, title: "Rich Heritage", desc: "Bishnupur’s terracotta temples, Bankura’s traditional art, and cultural landmarks.", route: "/frontpage" },
          ...
          f.route ? (
            <motion.a
              ...
              className="bg-white shadow-lg hover:shadow-2xl transition rounded-3xl p-10 border border-gray-100 cursor-pointer block"
            >
              {f.icon}
